...
<head>
  ...
  <link
    ...
    rel="stylesheet">
  <title>Jaisalmer Camping & Trekking</title>
...
<body>
  <form method="POST">
    <section class="hero">
      <div class="title">
        <h4>Jaisalmer Camping & Trekking &nbsp; &nbsp;<span class="price">₹7000/- Per Person</span></h4>
      </div>
    </section>
    <div class="slideshow-container">
      <div class="mySlides fade">
        <img src="Img/5_Jaisalmer/Jaisalmer(1).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/5_Jaisalmer/Jaisalmer(2).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/5_Jaisalmer/Jaisalmer(3).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/5_Jaisalmer/Jaisalmer(4).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/5_Jaisalmer/Jaisalmer(5).jpg" style="width:100%">
      </div>
      ...
      <div class="iamge-text">
        <p style="color: black;"><b>Jaisalmer Camping & Trekking</b></p>
        <i class='bx bxs-sun'>4</i>&nbsp;<i class='bx bxs-moon'>3</i>
        <p style="color: #666;">The city's most prominent landmark is the Jaisalmer Fort, also called Sonar Qila (Golden
          Fort). Unlike most other forts in India, Jaisalmer Fort is not just a tourist attraction. It houses shops,
          hotels and ancient havelis (homes) where generations continue to live. Jaisalmer traces its inception to the
          12th century. The town lies in the heart of the Thar Desert (the Great Indian Desert) and has a population,
          including the residents of the fort, of about 78,000. Jaisalmer ranked 9th on Booking.com's Top 10 The Most
          Welcoming cities in the world.</p>
        <div class="button"><a href="Img/5_Jaisalmer/Jaisalmer Camping & Trekking.pdf" class="anchor"><span>Download
              Brochure</span></a></div>
        ...
        <div class="input-row">
          <div class="input-group">
            ...
            <select id="destination" placeholder="Select destination" name="des" required>
              ...
              <option value="Jaisalmer Desert Camping & Trekking" selected>Jaisalmer Desert Camping & Trekking</option>
            </select>
          </div>
          <div class="input-group">
