...
<head>
  ...
  <title>The Leh Ladakh Camaping & Road Trip</title>
...
<body>
  <form method="POST">
    <section class="hero">
      <div class="title">
        <h4>The Leh Ladakh Camaping & Road Trip &nbsp; &nbsp;<span class="price">₹26,000/- Per Person</span></h4>
      </div>
    </section>
    <div class="slideshow-container">
      <div class="mySlides fade">
        <img src="Img/9_lehladakh/lehladhk(1).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/9_lehladakh/lehladhk(2).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/9_lehladakh/lehladhk(3).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/9_lehladakh/lehladhk(4).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/9_lehladakh/lehladhk(5).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/9_lehladakh/lehladhk(6).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/9_lehladakh/lehladhk(7).jpg" style="width:100%">
      </div>
      ...
      <div class="iamge-text">
        <p style="color: black;"><b>The Leh Ladakh Camaping & Road Trip</b></p>
        <i class='bx bxs-sun'>15</i>&nbsp;<i class='bx bxs-moon'>14</i>
        <p style="color: #666;">Leh is a city in Ladakh in the Himalayan region. It is the largest city and the joint
          capital of Ladakh. Leh, located in the Leh district, was also the historical capital of the Kingdom of
          Ladakh.Leh Ladakh is open for tourists and tourists can still visit major tourist attractions of Ladakh like
          Pangong lake, Changla pass, Khardungla pass, Nubra, Valley, Sham valley (Sangam, magnetic hill etc) after
          obtaining the permit.</p>
        <div class="button"><a href="Img/9_lehladakh/The Leh Ladakh Camaping & Road Trip.pdf"
        ...
        <div class="input-row">
          <div class="input-group">
            ...
            <select id="destination" placeholder="Select destination" name="des" required>
              ...
              <option value="The Leh Ladakh Camaping & Road Trip" selected >The Leh Ladakh Camaping & Road Trip</option>
            </select>
          </div>
          <div class="input-group">
