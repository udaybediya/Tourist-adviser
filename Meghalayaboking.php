...
<title>Meghalaya - Scotland of the East</title>
...
<body>
  <form method="POST">
    <section class="hero">
        <div class="title">
            <h4>Meghalaya - Scotland of the East &nbsp; &nbsp;<span class="price">₹22000/- Per Person</span></h4>
        </div>
    </section>
    <div class="slideshow-container">
        <div class="mySlides fade">
            <img src="Img/4_Meghalaya/Meghalaya(1).jpg" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="Img/4_Meghalaya/Meghalaya(2).jpg" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="Img/4_Meghalaya/Meghalaya(3).jpg" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="Img/4_Meghalaya/Meghalaya(4).jpg" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="Img/4_Meghalaya/Meghalaya(5).jpg" style="width:100%">
        </div>
        ...
        <div class="iamge-text">
            <p style="color: black;"><b>Meghalaya - Scotland of the East</b></p>
            <i class='bx bxs-sun'>7</i>&nbsp;<i class='bx bxs-moon'>6</i>
            <p style="color: #666;">Meghalaya, also known as the Abode of Clouds, falls in one of the richest biodiversity areas in the world. The famed monsoons, the rich traditional festivals, and the dramatic terrain are just some of the many things this state is famous for. in the maghalaya Living Root Bridges-Cherrapunji, Elephant Falls-Shillong, Umiam Lake-Shillong, Mawsynram-East Khasi Hills District, Nohkalikai Falls-Cherrapunji are famous places.</p>
            <div class="button"><a href="Img/4_Meghalaya/Meghalaya - Scotland of the East.pdf" class="anchor"><span>Download Brochure</span></a></div>
        </div>
        ...
        <div class="input-row">
          <div class="input-group">
            ...
            <select id="destination" placeholder="Select destination" name="des" required>
              ...
              <option value="Meghalaya - Scotland of the East"selected >Meghalaya - Scotland of the East</option>
            </select>
          </div>
          <div class="input-group">
