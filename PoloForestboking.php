...
<head>
  ...
  <link
    ...
    rel="stylesheet">
  <title>Polo Forest - Trekking Camp</title>
...
<body>
  <form method="POST">
    <section class="hero">
      <div class="title">
        <h4>Polo Forest - Trekking Camp &nbsp; &nbsp;<span class="price">₹1000/- Per Person</span></h4>
      </div>
    </section>
    <div class="slideshow-container">
      <div class="mySlides fade">
        <img src="Img/2_Polo Forest/PoloForest(1).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/2_Polo Forest/PoloForest(3).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/2_Polo Forest/PoloForest(4).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/2_Polo Forest/PoloForest(5).jpg" style="width:100%">
      </div>
      ...
      <div class="iamge-text">
        <p style="color: black;"><b>Polo Forest - Trekking Camp</b></p>
        <i class='bx bxs-sun'>1</i>&nbsp;<i class='bx bxs-moon'>0</i>
        <p style="color: #666;">The ancient Polo city was built around the river Harnav, an ancient water body spoken of
          in the Puranas. It is believed to have been established in the 10th century by the Parihar kings of Idar, and
          was then conquered in the 15th century by the Rathod Rajputs of Marwar. The name is derived from pol, the
          Marwari word for "gate," signifying its status as a gateway between Gujarat and Rajasthan. It was built
          between Kalaliyo in the east, the highest peak in the area, and Mamrehchi in the west, considered sacred by
          the local adivasis.</p>
        <div class="button"><a href="Img/2_Polo Forest/Polo Forest - Trekking Camp.pdf" class="anchor"><span>Download
              Brochure</span></a></div>
      </div>
        ...
        <div class="input-row">
          <div class="input-group">
            ...
            <select id="destination" placeholder="Select destination" name="des" required>
              ...
              <option value="Polo Forest - Trekking Camp" selected>Polo Forest - Trekking Camp</option>
            </select>
          </div>
          <div class="input-group">
