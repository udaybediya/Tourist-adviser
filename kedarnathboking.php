...
<head>
  ...
  <title>Kedarnath with Chpota-Tungnath Trek</title>
...
<body>
  <form method="POST">
    <section class="hero">
      <div class="title">
        <h4>Kedarnath with Chpota-Tungnath Trek &nbsp; &nbsp;<span class="price">₹11,200/- Per Person</span></h4>
      </div>
    </section>
    <div class="slideshow-container">
      <div class="mySlides fade">
        <img src="Img/8_kedarnath/Kedarnath(1).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/8_kedarnath/Kedarnath(2).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/8_kedarnath/Kedarnath(3).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/8_kedarnath/Kedarnath(4).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/8_kedarnath/Kedarnath(5).jpg" style="width:100%">
      </div>
      <div class="mySlides fade">
        <img src="Img/8_kedarnath/Kedarnath(6).jpg" style="width:100%">
      </div>
      ...
      <div class="iamge-text">
        <p style="color: black;"><b>Kedarnath with Chpota-Tungnath Trek</b></p>
        <i class='bx bxs-sun'>9</i>&nbsp;<i class='bx bxs-moon'>8</i>
        <p style="color: #666;">The Kedarnath and Tungnath Yatra is a sacred pilgrimage in the Indian state of
          Uttarakhand that takes you to two prominent Hindu temples located in the Garhwal Himalayas. The Kedarnath and
          Tungnath Yatra is typically undertaken by devotees and pilgrims seeking spiritual enlightenment and blessings
          from Lord Shiva. Chopta is a small hill station in uttarakhand comprised of meadows and evergreen forest with
          trek & camping chopta is known for its sunset beauty. Tungnath is famously known as the tungnath dedicated to
          lord Shiva this temple is the highest shiva temple in the world and highest among the other panch Kedar
          temple.</p>
        <div class="button"><a href="Img/8_kedarnath/Kedarnath with Chpota-Tungnath Trek.pdf"
            class="anchor"><span>Download Brochure</span></a></div>
      </div>
        ...
        <div class="input-row">
          <div class="input-group">
            ...
            <select id="destination" placeholder="Select destination" name="des" required>
              ...
              <option value="Kedarnath with Chpota-Tungnath Trek" selected>Kedarnath with Chpota-Tungnath Trek</option>
            </select>
          </div>
          <div class="input-group">
